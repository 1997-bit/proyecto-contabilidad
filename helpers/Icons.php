...
/**
 * Iconos SVG inline reutilizables (estilo trazo, sin librerias externas).
 * Heredan color de texto via stroke="currentColor".
 */
class Icons
{
  private const PATHS = [
    'home' => '<path d="M3 12l9-9 9 9"/><path d="M9 21V12h6v9"/><path d="M5 10v11h14V10"/>',
  ...
  public static function svg(string $nombre, int $size = 16): string
  {
    $path = self::PATHS[$nombre] ?? '';
