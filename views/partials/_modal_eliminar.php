<dialog id="dlg-eliminar" onclick="if(event.target===this){cerrarEliminar()}">
    <h3 style="margin-top:0;color:#c00">Eliminar colaborador</h3>
    ...
    <input type="text" id="del-confirmacion" placeholder="Escribe el nombre aquí"
           oninput="verificarNombre()" style="width:100%;box-sizing:border-box;margin-bottom:8px">

    <form method="POST" action="<?= BASE_URL ?>/colaborador/eliminar" id="form-eliminar">
        <input type="hidden" name="id" id="del-id">
        <div style="display:flex;gap:8px">
            <button type="submit" id="btn-confirmar-eliminar" disabled
                    style="background:#c00;color:#fff;border:none;padding:4px 12px;cursor:pointer">
...
function verificarNombre() {
    ...
    document.getElementById('btn-confirmar-eliminar').disabled = (val !== _nombreEliminar);
}
