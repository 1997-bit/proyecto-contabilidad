    ...
    <form method="POST" action="<?= BASE_URL ?>/colaborador/editar">
        ...
        <table style="width:auto;border:none">
            <tr>
                ...
                <td><input type="text" id="edit-nombre" name="nombre_completo" required style="width:220px"></td>
            </tr>
            <tr>
                <td><label for="edit-cedula">Cédula</label></td>
                <td><input type="text" id="edit-cedula" name="cedula" placeholder="8-123-4567"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="edit-cargo" name="cargo" required style="width:220px"></td>
            </tr>
            <tr>
                <td><label for="edit-salario">Salario base (B/.)</label></td>
                <td><input type="number" id="edit-salario" name="salario_base" step="0.01" min="0.01" required></td>
            </tr>

            <tr>
                <td><label for="edit-anio">Año de inicio</label></td>
                <td><input type="number" id="edit-anio" name="anio_inicio" min="1900" max="<?= date('Y') ?>" required></td>
            </tr>
            <tr>
                <td></td>
