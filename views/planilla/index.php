...
<style>
  ...
  input[type=text],
  input[type=number],
  select   { width: 190px; padding: 2px 4px; margin-bottom: 4px; }
  ...
  table.planilla th  { background: #ddd; text-align: center; }
  table.planilla .num { text-align: right; }
  table.planilla tfoot td { background: #f5f5c0; font-weight: bold; }
  table.planilla tfoot .num { text-align: right; }
  tr.alerta { background: #fdd !important; }
  .badge-alerta { color: red; font-size: 10px; display: block; }
...
<p class="sub">Usa <code>PlanillaService</code> e <code>ISRService</code> del proyecto. Sin persistencia en BD.</p>
...
<form method="POST" action="<?= BASE_URL ?>/planilla/agregar">
  ...
  <fieldset>
    ...
    <input type="number" id="otros_descuentos" name="otros_descuentos"
...
function toggleHoras(sel) {
  ...
  const monto = row.querySelector('input[name="ing_monto[]"]');
